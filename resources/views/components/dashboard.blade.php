            ...
            <div class="flex h-screen bg-gray-100 dark:bg-gray-800 font-roboto">
                ...
                <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                    ...
                    <nav class="flex flex-col mt-10 px-4 text-center">
                        ...
                        <a href="{{ url('/students') }}"
                            class="mt-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100  hover:bg-gray-200 dark:hover:bg-gray-800 rounded">Students</a>
                        <a href="{{ url('/dropdown') }}"
                            class="mt-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">Drop Down</a>
                        {{--<a href="#"
                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto">
                        <div class="w-full h-5/6 mx-auto px-6 py-8">
                            <div>
                                {{ $slot }}
                            </div>
                        </div>
